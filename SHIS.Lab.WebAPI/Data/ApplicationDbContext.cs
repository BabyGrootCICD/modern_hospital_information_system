...
using SHIS.Lab.WebAPI.Models;
using Microsoft.AspNetCore.Identity;

namespace SHIS.Lab.WebAPI.Data
{
    public partial class ApplicationDbContext : IdentityDbContext
    {
        ...
        public DbSet<ShisChart> ShisChart { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.HealthId).HasName("SHISCHART_pkey");

                entity.ToTable("shis_chart");

                entity.HasIndex(e => new { e.PatientFirstname, e.PatientMidname, e.PatientLastname }, "idx_shis_chart_01");

                entity.HasIndex(e => e.MobilePhone, "idx_shis_chart_02");
