...
public partial class GatewayContext : DbContext
{
    ...
    public virtual DbSet<ShisChartMergeHistory> ShisChartMergeHistories { get; set; }
    ...
    public virtual DbSet<ShisUploadLog> ShisUploadLogs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        //=> optionsBuilder.UseNpgsql("Server=172.18.18.78;Database=SHIS;Port=5432;User ID=hisuser;Password=Shish@$^");
        //=> optionsBuilder.UseNpgsql("Server=172.18.18.78;Database=BORH;Port=5432;User ID=hisuser;Password=Shish@$^");
        //=> optionsBuilder.UseNpgsql("Server=172.18.18.78;Database=SHIS;Port=5432;User ID=hisuser;Password=Shish@$^");
        //=> optionsBuilder.UseNpgsql("Server=localhost;Database=SHIS; Port=5432; User ID=postgres;Password=abdi;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AttrCode).HasName("shis_attribute_pkey");
        ...
        {
            entity.HasKey(e => e.ChrHealthId).HasName("SHISCHART_pkey");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("SHISCHARTLOG_pkey");
        ...
        modelBuilder.Entity<ShisChartMergeHistory>(entity =>
        {
            entity.ToTable("shis_chart_MergeHistory");
        ...
        {
            entity.HasKey(e => e.RefId).HasName("shis_coderef_pkey");
        ...
        {
            entity.HasKey(e => new { e.CndCodetype, e.CndCode }).HasName("shis_condition_pkey");
        ...
        {
            entity.HasKey(e => e.DptCode).HasName("shis_department_pkey");
        ...
        {
            entity.HasKey(e => e.IcdCode).HasName("SHISICD_pkey");

            entity.ToTable("shis_icd", tb => tb.HasComment("Diagnosis data."));
        ...
        {
            entity.HasKey(e => e.FrqCode).HasName("shis_medfrequency_pkey");
        ...
        {
            entity.HasKey(e => new { e.FrqCode, e.IndCode }).HasName("shis_medfrequency_ind_pkey");
        ...
        {
            entity.HasKey(e => e.MedId).HasName("SHISMEDICINE_pkey");
        ...
        {
            entity.HasKey(e => new { e.MedType, e.PathCode }).HasName("shis_medpathway_pkey");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("shis_non_medicine_pkey");
        ...
        modelBuilder.Entity<ShisUploadLog>(entity =>
        {
            entity.HasKey(e => e.Logid).HasName("shis_upload_log_pkey");

            entity.ToTable("shis_upload_log");
        ...
        {
            entity.HasKey(e => e.UserIdno).HasName("shis_users_pkey");

            entity.ToTable("shis_users", tb => tb.HasComment("Account Basic File(user account )"));
