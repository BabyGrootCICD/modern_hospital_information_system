...
{
    [DbContext(typeof(SHISContext))]
    partial class SHISContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ClinicSchedule", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.Dhis2Disease", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.Hisorderplan", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.HisorderplanAttr", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.Hisordersoa", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.home_physicalsign", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.shis_chart_MergeHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("shis_chart_MergeHistory");
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.shis_mental", b =>
                {
                    ...
                    b.ToTable("shis_mental");
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.SHIS_MergeHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SHIS_MergeHistory");
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.shis_ncd", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisAttribute", b =>
                {
                    b.Property<string>("AttrCode")
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)")
                    ...
                    b.ToTable("shis_attribute", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisAuth", b =>
                {
                    ...
                    b.ToTable("shis_auths", (string)null);

                    b.HasComment("User Auth File(Account permissions)");
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisAuthsLog", b =>
                {
                    ...
                    b.ToTable("shis_auths_log", (string)null);

                    b.HasComment("Auth change log");
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisChart", b =>
                {
                    ...
                    b.HasIndex(new[] { "ChrPatientFirstname", "ChrPatientMidname", "ChrPatientLastname" }, "idx_shis_chart_01");

                    b.HasIndex(new[] { "ChrMobilePhone" }, "idx_shis_chart_02");

                    b.ToTable("shis_chart", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisChartLog", b =>
                {
                    ...
                    b.HasIndex(new[] { "ChrHealthId" }, "idx_shis_chart_log_01");

                    b.ToTable("shis_chart_log", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisCoderef", b =>
                {
                    ...
                    b.ToTable("shis_coderef", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisCondition", b =>
                {
                    ...
                    b.ToTable("shis_condition", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisDepartment", b =>
                {
                    ...
                    b.ToTable("shis_department", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisIcd", b =>
                {
                    ...
                    b.ToTable("shis_icd", (string)null);

                    b.HasComment("Diagnosis data.");
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisMedfrequency", b =>
                {
                    ...
                    b.ToTable("shis_medfrequency", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisMedfrequencyInd", b =>
                {
                    b.Property<string>("FrqCode")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.ToTable("shis_medfrequency_ind", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisMedicine", b =>
                {
                    ...
                    b.ToTable("shis_medicine", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisMedpathway", b =>
                {
                    ...
                    b.ToTable("shis_medpathway", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisNonMedicine", b =>
                {
                    ...
                    b.ToTable("shis_non_medicine", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisProject", b =>
                {
                    b.Property<string>("ProjectId")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                    ...
                    b.ToTable("shis_projects", (string)null);

                    b.HasComment("Auth Setting reference Project File(main function node)");
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisSerialpool", b =>
                {
                    ...
                    b.ToTable("shis_serialpool", (string)null);
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisUser", b =>
                {
                    b.Property<string>("UserIdno")
                        .HasMaxLength(7)
                        .HasColumnType("character varying(7)")
                    ...
                    b.ToTable("shis_users", (string)null);

                    b.HasComment("Account Basic File(user account )");
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisUsersLog", b =>
                {
                    b.Property<string>("UserIdno")
                        .HasColumnType("text")
                        .HasColumnName("user_idno");
                    ...
                    b.ToTable("shis_users_log", (string)null);

                    b.HasComment("Account change log(帳號基本檔修改紀錄表2023.03.03)");
                });

            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.PhysicalSign", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.Registration", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.TestResult", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.TransactionCall", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.TransactionFee", b =>
                {
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.HisorderplanAttr", b =>
                {
                    b.HasOne("SHIS.HisOrder.MVC.Models.Hisorderplan", "Orderplan")
            ...
            modelBuilder.Entity("SHIS.HisOrder.MVC.Models.ShisAuth", b =>
                {
                    b.HasOne("SHIS.HisOrder.MVC.Models.ShisUser", "UserIdnoNavigation")
                        .WithMany("ShisAuths")
