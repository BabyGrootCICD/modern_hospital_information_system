...
namespace SHIS.HisOrder.MVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, IStringLocalizer<SharedResource> localizer, SHISContext context)
        {
            _logger = logger;
        ...
        public List<DeptForChart> GetClinicSchedules(DateTime ChosenDate)
        {
            ...
            var csData = from c in _context.Set<ClinicSchedule>()
                         join b in _context.Set<ShisDepartment>()
