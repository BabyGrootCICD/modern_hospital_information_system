...
using SHIS.HisOrder.MVC.Areas.MedicalRecord.Models;
using SHIS.HisOrder.MVC.Areas.MedicalRecord.ViewModels;
using SHIS.HisOrder.MVC.Areas.Reservation.Models;
...
namespace SHIS.HisOrder.MVC.Areas.Reservation.Conrollers
{
    ...
    public class AjaxController : Controller
    {
        ...
        public AjaxController(SHISContext context)
        {
            _context = context;
        }
        ...
        public PartialViewResult ShowReserveContent(string reserveType, string? PatientID)
        {
            ...
            List<ShisAttribute> attrList = new List<ShisAttribute>();
            attrList = _context.ShisAttributes.ToList();
