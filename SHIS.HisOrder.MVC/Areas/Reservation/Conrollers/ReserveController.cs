...
namespace SHIS.HisOrder.MVC.Areas.Reservation.Conrollers
{
    [Area("Reservation")]
    ...
    public class ReserveController : Controller
    {
        ...
        public ReserveController(SHISContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Details(string? id, string? cancelList, string? hideList)
        {
            ...
            TempData["DepName"] = _context.ShisDepartments.SingleOrDefault(e => e.DptCode == id).DptName;
            TempData["DeptId"] = _context.ShisDepartments.SingleOrDefault(e => e.DptCode == id).DptCode;
        ...
        public async Task<IActionResult> getData(string PatientID)
        {
            ...
            var dpt = _context.ShisDepartments.Where(e => e.DptParent == "6000" || e.DptParent == "3000").ToList();
        ...
        public async Task<IActionResult> NR(string PatientID)
        {
            ...
            var getPatient = _context.ShisCharts.FirstOrDefault(e => e.ChrHealthId == PatientID);
