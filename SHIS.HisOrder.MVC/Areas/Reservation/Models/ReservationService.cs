...
namespace SHIS.HisOrder.MVC.Areas.Reservation.Models
{
    public class ReservationService : IDisposable
    {
        ...
        public ReservationService(SHISContext context)
        {
            _context = context;
        }
            ...
            EnumClass.DisplayLanguage language)
        {
            ...
            List<ShisCoderef> statusList = new List<ShisCoderef>();
            ...
            using (CommonService cService = new CommonService(_context))
            {
                try
                {
                    statusList = _context.ShisCoderefs.Where(c => c.RefCodetype == "Reserve_StatusCode").ToList();
            ...
            string modifyID)
        {
            ...
            var chartDto = _context.ShisCharts.Where(c => c.ChrHealthId == reserveInfo.patientID);
        ...
        private short GenerateSeqNo(DateTime reserveDate, ClinicSchedule clinicInfo, ShisChart patientInfo, ref EnumClass.ReplyNoCode replyCode)
        {
            #region local variables
        ...
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        private EnumClass.ReplyNoCode Complete(AppointmentStructure reserveInfo, ClinicSchedule clinicInfo, ShisChart patientInfo, short seqNo, string ModifyID, ref Registration reg)
        {
