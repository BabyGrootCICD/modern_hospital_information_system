...
namespace SHIS.HisOrder.MVC.Areas.HisCalling.Models
{    
    public class CallService : IDisposable
    {
        private readonly SHISContext _context;

        public CallService(SHISContext context)
        {
            _context = context;
        }
        ...
        public List<ClinicSchedule> getCallGroup(string inWeek, string inArea, string inNoon)
        {
            ...
            try
            {
                var rooms = _context.ShisCoderefs
        ...
        public List<SelectListItem> getCallArea(string inArea = null)
        {
            ...
            try
            {
                var arealist = _context.ShisCoderefs.Where(c => c.RefCodetype == "call_area")
