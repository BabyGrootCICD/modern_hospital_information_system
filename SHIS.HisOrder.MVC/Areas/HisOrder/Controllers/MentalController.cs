...
namespace SHIS.HisOrder.MVC.Areas.HisOrder.Controllers
{
    ...
    public class MentalController : Controller
    {
        ...
        public MentalController(SHISContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Index(string inhospitalId, string HealthId, string NmType, string date)
        {
            ...
            IEnumerable<ExtendShisNonMedicine> data = (from a in _context.ShisNonMedicines
                                                      ...
                                                      join c in _context.shis_mental on a.ItemId equals c.plancode
        ...
        [HttpPost]
        public async Task<IActionResult> SaveMnt(string inhospitalId, string healthId, string[] items, string[] inps, string NmType, string date, shis_mental _Mental)
        {
            var login = HttpContext.Session.GetObject<LoginDTO>("LoginDTO");
            foreach (var item in items)
            {
                var exits = _context.shis_mental.Where(e => e.plancode == item && e.healthid == healthId).ToList();
                ...
                if (itemType == "17" || itemType == "18")
                {
                    ...
                    else
                    {
                        ...
                        await _context.shis_mental.AddRangeAsync(_Mental);
                ...
                {
                    var exitsitem = _context.shis_mental.Where(e => e.plancode == item && e.inhospid == inhospitalId).ToList();
        ...
        public IActionResult Detail(string healthId, string NmType, string inhosp, bool showClinic = true, bool showPrint = false)
        {
            ...
            var dpt = _context.ShisDepartments.Where(e => e.DptParent == "4000").ToList();
