...
namespace SHIS.HisOrder.MVC.Areas.HisOrder.Controllers
{
    ...
    public class PrintController : Controller
    {
        ...
        public PrintController(SHISContext context)
        {
            _context = context;
        }
        ...
        private void SetGlobalPrintData(string inHospID = null, string inOrderplanids = null)
        {
            try
            {
                using (HisOrderController col = new HisOrderController(_context))
                {
                    ...
                    GlobalPrintData.HospName = _context.ShisCoderefs.Where(c => c.RefCodetype == "HospitalCode").Select(c => c.RefName).FirstOrDefault().ToString();
                    ...
                    List<ShisMedpathway> DosePathData = _context.ShisMedpathways.ToList();
                    ...
                    string ShowFontStyle = _context.ShisCoderefs.Where(c => c.RefCodetype == "PrintMedicalStyle").Select(c => c.RefCode).FirstOrDefault();
                    ...
                    ViewData["Locations"] = _context.ShisCoderefs.Where(c => c.RefCodetype == "NonMedLocation").ToList();
