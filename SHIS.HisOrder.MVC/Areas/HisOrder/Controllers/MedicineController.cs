...
namespace SHIS.HisOrder.MVC.Areas.HisOrder.Controllers
{
    ...
    public class MedicineController : Controller
    {
        ...
        public MedicineController(SHISContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public IActionResult ReloadPartialView()
        {
            ...
            using (HisOrderController col = new HisOrderController(_context))
            {
                ...
                if (grv.Patient != null)
                {
                    ...
                    ViewData["MedFreq"] = _context.ShisMedfrequencies.OrderBy(c => c.FrqSeqNo).ToList();
                    ViewData["MedIndication"] = _context.ShisMedfrequencyInds.OrderBy(c => c.Showseq).ToList();
                    ViewData["MedPathWay"] = _context.ShisMedpathways.OrderBy(c => c.Showseq).ToList();
        ...
        public string GetMedicineItem()
        {
            ...
            var data = _context.ShisMedicines.ToList();
        ...
        {
            ResultDTO result = new ResultDTO() { isSuccess = false };
            var data = _context.ShisMedpathways.OrderBy(c => c.Showseq).ToList();
        ...
        {
            ResultDTO result = new ResultDTO() { isSuccess = false };
            var data = _context.ShisMedfrequencyInds.OrderBy(c => c.Showseq).ToList();
        ...
        {
            ResultDTO result = new ResultDTO() { isSuccess = false };
            var data = _context.ShisMedfrequencies.OrderBy(c => c.FrqSeqNo).ToList();
