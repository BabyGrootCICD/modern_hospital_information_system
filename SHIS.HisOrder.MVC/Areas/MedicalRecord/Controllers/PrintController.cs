...
namespace SHIS.HisOrder.MVC.Areas.MedicalRecord.Controllers
{
    ...
    public class PrintController : Controller
    {
        ...
        public PartialViewResult PrintPersonalCard(string patientID)
        {
            ...
            PersonalPrintData.HospName = _context.ShisCoderefs.Where(c => c.RefCodetype == "HospitalCode").Select(c => c.RefName).FirstOrDefault().ToString();
            var Dtos = _context.ShisCharts.Where(c => c.ChrHealthId == patientID);
