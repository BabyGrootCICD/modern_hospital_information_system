...
namespace SHIS.HisOrder.MVC.Areas.MedicalRecord.ViewModels
{
    ...
    public partial class MRCreateClass
    {
        ...
        private List<ShisCoderef>? _AreaList;
        /// <summary>
        /// 地區碼
        /// </summary>
        public List<ShisCoderef>? AreaList
        {
            get { return _AreaList; }
            set { _AreaList = value; }
        }

        private List<ShisCoderef>? _RelationList;
        /// <summary>
        /// 關係
        /// </summary>
        public List<ShisCoderef>? RelationList
        {
            get { return _RelationList; }
            set { _RelationList = value; }
        }

        private List<ShisCoderef>? _NationPhoneList;
        /// <summary>
        /// 電話國碼
        /// </summary>
        public List<ShisCoderef>? NationPhoneList
        {
