...
namespace SHIS.HisOrder.MVC.Extesion
{
    public class DataCheckFunction
    {
        ...
        /// <returns></returns>
        public static EnumClass.ReplyNoCode CheckAppointmentData(SHISContext _context, AppointmentStructure appointmentStructure)
        {
            ...
            if (!_context.ShisAttributes.Where(c => c.AttrCode == appointmentStructure.reserveAttr).Any())
            {
                return EnumClass.ReplyNoCode.WrongDept;
            }
