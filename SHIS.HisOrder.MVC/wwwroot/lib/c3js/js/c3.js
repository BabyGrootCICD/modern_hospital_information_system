...
(function (global, factory) {
  ...
  AxisInternal.prototype.tspanData = function (d, i, scale) {
      var internal = this;
      var splitted = internal.params.ticshisltiline
          ? internal.splitTickText(d, scale)
          : [].concat(internal.textFormatted(d));
      if (internal.params.ticshisltiline && internal.params.ticshisltilineMax > 0) {
          splitted = internal.ellipsify(splitted, internal.params.ticshisltilineMax);
      }
  ...
  Axis.prototype.getXAxis = function getXAxis(scale, orient, tickFormat, tickValues, withOuterTick, withoutTransition, withoutRotateTickText) {
      var $$ = this.owner, config = $$.config, axisParams = {
          ...
          ticshisltiline: config.axis_x_tick_multiline,
          ticshisltilineMax: config.axis_x_tick_multiline
